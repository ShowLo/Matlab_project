...
str = strcat(str,str,str,str,str,str);
%将信息隐藏在DCT系数矩阵之中
dctMatrix_hide = hide_trans_2(dctMatrix,str);
...
str_dt1= decrypt_trans_2(result);
%第二种方法，通过隐藏了信息的图像经过处理得到的DCT系数矩阵解密
str_dt2 = decrypt_trans_2(getDCTmatrix(hall_decode));